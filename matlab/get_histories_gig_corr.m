...
root='/Users/Peter/Documents/WORK/NH_SH_bh/glob_bh_new_GIG_corr/Samples/';
extension='G.txt';
...
save outputs/mean_G_gIgcorr.txt mean_G -ascii
save outputs/stdev_G_gIgcorr.txt stdev_G -ascii
save outputs/pp_array_gIgcorr.txt pp_array -ascii
...
save outputs/Tglob_new_gIgcorr.txt glob -ascii
save outputs/Tglob_new_p2s_gIgcorr.txt glob_p2s -ascii
save outputs/Tglob_new_m2s_gIgcorr.txt glob_m2s -ascii

save outputs/Tglob_new_p3s_gIgcorr.txt glob_p3s -ascii
save outputs/Tglob_new_m3s_gIgcorr.txt glob_m3s -ascii

save outputs/TSH_new_gIgcorr.txt SH -ascii
save outputs/TSH_new_p2s_gIgcorr.txt SH_p2s -ascii
save outputs/TSH_new_m2s_gIgcorr.txt SH_m2s -ascii

save outputs/TSH_new_p3s_gIgcorr.txt SH_p3s -ascii
save outputs/TSH_new_m3s_gIgcorr.txt SH_m3s -ascii
...
print -painters -depsc2 -r2500 plots/dT_glob_gIgcorr.eps
...
colorbar
pbaspect([2 1 1])
print -painters -depsc2 -r2500 plots/hyperprior_glob_gIgcorr.eps
