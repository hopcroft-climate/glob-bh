...
yearsAD=[1405:5:2015];
load outputs_hcond/Tglob_new.txt
load outputs_hcond/Tglob_new_p2s.txt
load outputs_hcond/Tglob_new_m2s.txt
load outputs_hcond/Tglob_new_p3s.txt
load outputs_hcond/Tglob_new_m3s.txt

load outputs_hcond/TSH_new.txt
load outputs_hcond/TSH_new_p2s.txt
load outputs_hcond/TSH_new_m2s.txt
load outputs_hcond/TSH_new_p3s.txt
load outputs_hcond/TSH_new_m3s.txt
...
print -painters -depsc2 -r2500 tas_glob_hcond.eps
