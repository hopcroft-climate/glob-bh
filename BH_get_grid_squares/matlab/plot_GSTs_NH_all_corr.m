...
yearsAD=[1405:5:2015];
load outputs/Tglob_new_corr.txt
load outputs/Tglob_new_p2s_corr.txt
load outputs/Tglob_new_m2s_corr.txt
load outputs/Tglob_new_p3s_corr.txt
load outputs/Tglob_new_m3s_corr.txt

load outputs/TSH_new_corr.txt
load outputs/TSH_new_p2s_corr.txt
load outputs/TSH_new_m2s_corr.txt
load outputs/TSH_new_p3s_corr.txt
load outputs/TSH_new_m3s_corr.txt
...
mean_TGLOBAL=Tglob_new_corr;
TGLOB_p2s=Tglob_new_p2s_corr;
TGLOB_m2s=Tglob_new_m2s_corr;

TGLOB_p3s=Tglob_new_p3s_corr;
TGLOB_m3s=Tglob_new_m3s_corr;
 
mean_TSH=TSH_new_corr;
TSH_p2s=TSH_new_p2s_corr;
TSH_m2s=TSH_new_m2s_corr;

TSH_p3s=TSH_new_p3s_corr;
TSH_m3s=TSH_new_m3s_corr; 
...
% Plot all years
hmean=plot(yearsAD,mean_TGLOBAL-mean(mean_TGLOBAL(iclim6090_new:fclim6090_new)),'color',[0.15 0.4 0.9],'linewidth',2.0)
plot(yearsAD,TGLOB_p2s-mean(mean_TGLOBAL(iclim6090_new:fclim6090_new)),'color',[0.15 0.4 0.9])
plot(yearsAD,TGLOB_m2s-mean(mean_TGLOBAL(iclim6090_new:fclim6090_new)),'color',[0.15 0.4 0.9])
...
%plot(yearsAD(1:118),TGLOB_m3s(1:118)-mean(mean_TGLOBAL(iclim6090:fclim6090)),'color','blue')
% Plot all years
hmean=plot(yearsAD,mean_TSH-mean(mean_TSH(iclim6090_new:fclim6090_new)),'color',[0.15 0.4 0.9],'linewidth',2.0)
plot(yearsAD,TSH_p2s-mean(mean_TSH(iclim6090_new:fclim6090_new)),'color',[0.15 0.4 0.9])
plot(yearsAD,TSH_m2s-mean(mean_TSH(iclim6090_new:fclim6090_new)),'color',[0.15 0.4 0.9])
...
%hpollack=plot(pollack04(:,1),pollack04(:,2),'color',[0 0.6 0.4],'linewidth',2.0)
plot(pollack04(:,1),pollack04_corr(:,2),'color',[0.7 0.3 0.2],'linewidth',2.0)
...
xlim([1500 2010])
pbaspect([2 1 1])
print -painters -depsc2 -r2500 tas_glob_corr.eps
