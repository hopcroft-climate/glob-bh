...
root='/Users/Peter/Documents/WORK/NH_SH_bh/glob_bh_new_hcond/Samples/';
...
save outputs_hcond/mean_G.txt mean_G -ascii
save outputs_hcond/stdev_G.txt stdev_G -ascii
save outputs_hcond/pp_array.txt pp_array -ascii
...
save outputs_hcond/Tglob_new.txt glob -ascii
save outputs_hcond/Tglob_new_p2s.txt glob_p2s -ascii
save outputs_hcond/Tglob_new_m2s.txt glob_m2s -ascii

save outputs_hcond/Tglob_new_p3s.txt glob_p3s -ascii
save outputs_hcond/Tglob_new_m3s.txt glob_m3s -ascii

save outputs_hcond/TSH_new.txt SH -ascii
save outputs_hcond/TSH_new_p2s.txt SH_p2s -ascii
save outputs_hcond/TSH_new_m2s.txt SH_m2s -ascii

save outputs_hcond/TSH_new_p3s.txt SH_p3s -ascii
save outputs_hcond/TSH_new_m3s.txt SH_m3s -ascii
...
box on
pbaspect([2 1 1])
print -painters -depsc2 -r2500 plots/dT_glob_hcond.eps
...
colorbar
pbaspect([2 1 1])
print -painters -depsc2 -r2500 plots/hyperprior_glob_hcond_hcond.eps
