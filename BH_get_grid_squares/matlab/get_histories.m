...
%root='C:\Users\hopcrofp\Documents\NH_SH_bh\glob_bh_new\Samples\';
extension='G.txt';
...
save outputs/mean_G.txt mean_G -ascii
save outputs/stdev_G.txt stdev_G -ascii
save outputs/pp_array.txt pp_array -ascii
...
save outputs/Tglob_new.txt glob -ascii
save outputs/Tglob_new_p2s.txt glob_p2s -ascii
save outputs/Tglob_new_m2s.txt glob_m2s -ascii

save outputs/Tglob_new_p3s.txt glob_p3s -ascii
save outputs/Tglob_new_m3s.txt glob_m3s -ascii

save outputs/TSH_new.txt SH -ascii
save outputs/TSH_new_p2s.txt SH_p2s -ascii
save outputs/TSH_new_m2s.txt SH_m2s -ascii

save outputs/TSH_new_p3s.txt SH_p3s -ascii
save outputs/TSH_new_m3s.txt SH_m3s -ascii
...
save outputs/warming_6090_18001850.txt warming_6090_m_1800_1850 -ascii
save outputs/sd_6090_18001850.txt sd_warming_6090_m_1800_1850 -ascii
...
for ic=1:nparts
    ...
    if(warming_6090_m_1800_1850(ic)<=-0.2)
        color = cmp(1,:);
    end
...
set(gca, 'CLim',[-0.6, 2.2] );set(gca,'color',[0.8 0.8 0.8])
cbh=colorbar(gca);
%set(cbh,'XTick',[-0.6:0.4:2.2],'XTickLabel',{'-0.6','-0.2','0.2','0.6','1.0','1.4','1.8',''});
set(cbh,'YTick',[,-0.2,0.2,0.6,1.0,1.4,1.8,],'Location','eastoutside')
...
set(gca, 'CLim', [0, 0.35]);set(gca,'color',[0.8 0.8 0.8])
...
figure
hold all
ax4=plot(world(:,1),world(:,2),'color','black')
...
ax4.TitleFontSizeMultiplier = 0.9;
...
fig.InvertHardcopy = 'off';
set(gca,'color',[0.8 0.8 0.8])    
print -painters -depsc2 -r2500 plots/hyperprior_glob.eps
savefig('hyperprior_glob.fig')